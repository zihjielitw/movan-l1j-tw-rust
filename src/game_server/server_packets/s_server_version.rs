...
impl SServerVersion {
    ...
    pub fn get_packets(&mut self) -> Vec<u8> {
        ...
        self.server_base_packet.write_c(0x00);       // Auth ok?
        ...
        self.server_base_packet.write_c(0x00);      // unknown
        self.server_base_packet.write_c(0x00);      // unknown
        ...
        self.server_base_packet.write_c((chrono::offset::Local::now().timestamp_millis() / 1000) as i32);       // Uptime
        self.server_base_packet.write_h(0x01);
